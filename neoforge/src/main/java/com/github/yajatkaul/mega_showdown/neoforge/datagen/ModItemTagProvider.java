...
public class ModItemTagProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(MegaShowdownTags.Items.MEGA_STONE)
                ...
                .add(MegaShowdownItems.CLEFABLITE.get())
                .add(MegaShowdownItems.CRABOMINITE.get())
                .add(MegaShowdownItems.DELPHOXITE.get())
                .add(MegaShowdownItems.DRAGONINITE.get())
                .add(MegaShowdownItems.DRAMPANITE.get())
                .add(MegaShowdownItems.EMBOARITE.get())
                .add(MegaShowdownItems.EXCADRITE.get())
                .add(MegaShowdownItems.FERALIGITE.get())
                .add(MegaShowdownItems.FLOETTITE.get())
                .add(MegaShowdownItems.FROSLASSITE.get())
                .add(MegaShowdownItems.GLIMMORANITE.get())
                .add(MegaShowdownItems.GOLURKITE.get())
                .add(MegaShowdownItems.GRENINJITE.get())
                .add(MegaShowdownItems.HAWLUCHANITE.get())
                .add(MegaShowdownItems.MEGANIUMITE.get())
                .add(MegaShowdownItems.MEOWSTICITE.get())
                .add(MegaShowdownItems.RAICHUNITE_X.get())
                .add(MegaShowdownItems.RAICHUNITE_Y.get())
                .add(MegaShowdownItems.SCOVILLAINITE.get())
                .add(MegaShowdownItems.SKARMORITE.get())
                .add(MegaShowdownItems.STARMINITE.get())
                .add(MegaShowdownItems.VICTREEBELITE.get())
                .add(MegaShowdownItems.STARAPTITE.get())
                .add(MegaShowdownItems.SCOLIPITE.get())
                .add(MegaShowdownItems.SCRAFTINITE.get())
                .add(MegaShowdownItems.EELEKTROSSITE.get())
                .add(MegaShowdownItems.PYROARITE.get())
                .add(MegaShowdownItems.MALAMARITE.get())
                .add(MegaShowdownItems.BARBARACITE.get())
                .add(MegaShowdownItems.DRAGALGITE.get())
                .add(MegaShowdownItems.FALINKSITE.get())
                .add(MegaShowdownItems.CHESNAUGHTITE.get())
                .add(MegaShowdownItems.CHIMECHITE.get())
                .add(MegaShowdownItems.CHANDELURITE.get())
                .add(MegaShowdownItems.ABSOLITE_Z.get())
                .add(MegaShowdownItems.BAXCALIBRITE.get())
                .add(MegaShowdownItems.GARCHOMPITE_Z.get())
                .add(MegaShowdownItems.GOLISOPITE.get())
                .add(MegaShowdownItems.LUCARIONITE_Z.get()
                );
